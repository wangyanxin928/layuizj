...
;layui.define("jquery",function(e){
    ...
    g_dirname = uploadoption.g_dirname
    g_object_name = ''
    g_object_name_type = uploadoption.g_object_name_type
        ...
        init: {
            ...
            FilesAdded: function(up, files) {
                plupload.each(files, function(file) {
                    ...
                    if(uploadoption.type!="file"){
                        ...
                        document.getElementById(ossfiledivid).innerHTML += '<div id="' + file.id + '" filename="'+file.name+'" filesize="'+sizev+'">' + file.name + ' (' + sizev + ')<b> <button class="layui-btn layui-btn-small deletefile"><i class="layui-icon"></i> 删除</button> </b>'
            ...
            UploadProgress: function(up, file) {
                ...
                if(uploadoption.type=="file") {
                    ...
                    d.getElementsByTagName('b')[0].innerHTML = '<span>' + file.percent + '%</span><button class="layui-btn layui-btn-small deletefile" fileid="' + file.id + '"><i class="layui-icon"></i> 删除</button>';
